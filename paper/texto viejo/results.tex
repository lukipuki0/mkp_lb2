...
DDTW--3K was best for mknapcb2 and mknapcb9. On mknapcb4 ($n=100$, $m=10$),
DDTW--3K tied with DDTW--1K for the closest approach to the BKS, reaching a
fitness of $23{,}055$ against a BKS of $23{,}064$ (gap of $0.04\%$).
...
% Numerical sources: completed DTW campaign run_dtw_job_19070 and completed
% DDTW campaign run_ddtw_job_19066. Each contains 31 runs per CEC function.

\begin{table}[htbp]
\centering
\caption{Comparative performance on the IEEE CEC2022 benchmark suite ($D = 10$, $N = 31$ runs) against the theoretical global optimum $f^*$. Bold font in the algorithm columns indicates the best mean performance for each function; bold optima identify the reference values.}
...
\midrule
\textbf{F1} & \textbf{300.00} & \textbf{300.00} & 362.37 & 9391.78 & \textbf{300.00} & 624.79 & 300.45 & 300.47 \\
\textbf{F2} & \textbf{400.00} & 416.97 & 416.11 & 419.62 & \textbf{405.24} & 409.37 & 406.00 & 405.94 \\
\textbf{F3} & \textbf{600.00} & 606.58 & 603.52 & 642.16 & 610.75 & \textbf{600.24} & 603.53 & 603.69 \\
\textbf{F4} & \textbf{800.00} & 818.90 & \textbf{813.72} & 845.41 & 824.73 & 818.26 & 816.26 & 815.74 \\
\textbf{F5} & \textbf{900.00} & 901.04 & 905.15 & 1482.68 & 942.26 & \textbf{900.02} & 901.67 & 901.97 \\
\textbf{F6} & \textbf{1800.00} & 3947.25 & 5093.89 & 3535.33 & 3829.47 & 15608.38 & \textbf{3488.60} & 3532.53 \\
\textbf{F7} & \textbf{2000.00} & 2026.26 & 2031.49 & 2129.26 & 2033.23 & 2028.82 & \textbf{2020.43} & 2022.70 \\
\textbf{F8} & \textbf{2200.00} & 2261.91 & 2223.96 & 2253.11 & 2222.13 & 2227.50 & \textbf{2220.34} & 2221.18 \\
\textbf{F9} & \textbf{2300.00} & 2532.77 & 2540.92 & 2547.36 & \textbf{2529.28} & \textbf{2529.28} & 2529.28 & 2529.28 \\
\textbf{F10} & \textbf{2400.00} & 2603.30 & 2589.45 & 2893.67 & 2610.02 & 2538.04 & 2522.95 & \textbf{2522.83} \\
\textbf{F11} & \textbf{2600.00} & 2852.79 & 2783.77 & 2884.93 & 2756.62 & 2738.94 & \textbf{2651.79} & 2653.69 \\
\textbf{F12} & \textbf{2700.00} & 2879.46 & \textbf{2864.65} & 2958.75 & 2865.02 & 2864.77 & 2863.93 & \textbf{2863.76} \\
\bottomrule
\end{tabular}
}
\end{table}
...
\begin{itemize}
    \item On the unimodal function \textbf{F1} (Shifted and Rotated Zakharov), the means were $300.45$ for DTW and $300.47$ for DDTW, while the best run of both variants reached the exact optimum $300.00$ (DTW run 9 and DDTW run 8). The means are retained in the comparative table because it reports average performance over all 31 runs.
    \item On the hybrid and composition functions, DTW obtained the best mean among all methods on \textbf{F6} ($3488.60$), \textbf{F7} ($2020.43$), \textbf{F8} ($2220.34$), and \textbf{F11} ($2651.79$). DDTW obtained the best mean on \textbf{F10} ($2522.83$) and \textbf{F12} ($2863.76$), while both variants remained competitive on the remaining functions.
    \item Across all 12 test functions, both framework variants avoided the most extreme failure modes (e.g., WOA on F1/F5 or ACO on F6 with $15{,}608.38$). Their dispersion was lower than that of several weak baselines, although it was not uniformly lower on every function.
\end{itemize}

The completed campaigns yielded an average normalized mean gap of $10.281\%$
for DTW and $10.501\%$ for DDTW. The largest run-to-run dispersion occurred
on F6, with standard deviations of $1{,}821.99$ and $1{,}942.16$ for DTW and
DDTW, respectively; this function is therefore interpreted together with its
median and best-run value rather than its mean alone. The best run reached the
published optimum on F1, F5, and F11 for both variants.

The direct DTW--DDTW comparison found a lower DDTW mean at full precision on
five of the twelve functions, while DTW was lower on seven; the F9 difference
is negligible and tied at the reported precision. The average normalized gap was lower for DTW (10.281\% versus
10.501\% for DDTW). However, none of the 12 paired Wilcoxon comparisons remained
significant after Holm correction; the observed differences are therefore
descriptive.



% Best-run convergence and Delta diagnostics for the selected CEC2022 variant.
\input{cec_best_diagnostics_EN}
