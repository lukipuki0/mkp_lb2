...
\begin{figure}[htbp]
\centering
\includegraphics[width=\textwidth]{figures/framework_flowchart.png}
...
Paired Runs & $N$ & $31$ & Statistical sample size; corresponding executions are analysed as paired \\
\bottomrule
\end{tabular}
\end{table}
