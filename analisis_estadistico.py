...
-----------------------
Módulo genérico de Análisis Estadístico Inferencial reutilizable por
todos los benchmarks del proyecto (batch_benchmark, benchmark_continuo,
HRES2-H2, mezclas_mh, etc.)
